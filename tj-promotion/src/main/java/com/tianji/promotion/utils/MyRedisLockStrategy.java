...
public enum MyRedisLockStrategy {
    SKIP_FAST() {
        @Override
        public boolean tryLock(RLock lock, MyRedisLock prop) throws InterruptedException {
    ...
    public abstract boolean tryLock(RLock lock, MyRedisLock prop) throws InterruptedException;
}
